...
org.apache.flex.utils.CSSUtils.attributeFromColor = function(value) {
  ...
  return "#" + org.apache.flex.utils.StringPadder.pad(hexVal, "0", 6);
};
...
org.apache.flex.utils.CSSUtils.toColorWithAlpha = function(value) {
  ...
  if (stringValue.charAt(0) == '#') {
    ...
    parts4[3] *= 255;
    return ((org.apache.flex.utils.Language.uint(parts4[3]) << 24) + (org.apache.flex.utils.Language.uint(parts4[0]) << 16) + (org.apache.flex.utils.Language.uint(parts4[1]) << 8) + org.apache.flex.utils.Language.uint(parts4[2]));
  }
 ...
 */
org.apache.flex.utils.CSSUtils.prototype.FLEXJS_CLASS_INFO = { names: [{ name: 'CSSUtils', qName: 'org.apache.flex.utils.CSSUtils', kind: 'class' }] };
  ...
  return {
    ...
    methods: function () {
      return {
        ...
        '|attributeFromColor': { type: 'String', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'uint', optional: false } ]; }},
        '|toNumber': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'String', optional: false },{ index: 2, type: 'Number', optional: true } ]; }},
        '|toColor': { type: 'uint', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false } ]; }},
        '|toColorWithAlpha': { type: 'uint', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false } ]; }},
        '|getTopValue': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'Object', optional: false },{ index: 3, type: 'Number', optional: true } ]; }},
        '|getRightValue': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'Object', optional: false },{ index: 3, type: 'Number', optional: true } ]; }},
        '|getBottomValue': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'Object', optional: false },{ index: 3, type: 'Number', optional: true } ]; }},
        '|getLeftValue': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'Object', optional: false },{ index: 3, type: 'Number', optional: true } ]; }},
        '|getSideValue': { type: 'Number', declaredBy: 'org.apache.flex.utils.CSSUtils', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'Object', optional: false },{ index: 3, type: 'int', optional: false },{ index: 4, type: 'Number', optional: true } ]; }}
      };
    }
  };
};