/**
 * Generated by Apache Flex Cross-Compiler from org/apache/flex/core/AllCSSValuesImpl.as
 * org.apache.flex.core.AllCSSValuesImpl
 *
 * @fileoverview
 *
...
goog.provide('org.apache.flex.core.AllCSSValuesImpl');
 ...
 */
org.apache.flex.core.AllCSSValuesImpl = function() {
  org.apache.flex.core.AllCSSValuesImpl.base(this, 'constructor');
};
goog.inherits(org.apache.flex.core.AllCSSValuesImpl, org.apache.flex.events.EventDispatcher);
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.mainClass;
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.conditionCombiners;
 ...
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.init = function(mainClass) {
 ...
 * @return {boolean}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.isValidStaticMediaQuery = function(mq) {
  if (mq == null)
    return true;
  if (mq == "-flex-flash")
    return true;
 ...
 * @return {string}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.fixNames = function(s, mq) {
  if (mq != null)
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.values;
 ...
 * @return {*}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.getValue = function(thisObject, valueName, state, attrs) {
  ...
  if (org.apache.flex.core.AllCSSValuesImpl.inheritingStyles[valueName] != null && org.apache.flex.utils.Language.is(thisObject, org.apache.flex.core.IChild)) {
 ...
 * @return {*}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.getInheritingValue = function(thisObject, valueName, state, attrs) {
  state = typeof state !== 'undefined' ? state : null;
  attrs = typeof attrs !== 'undefined' ? attrs : null;
  var /** @type {*} */ value;
 ...
 * @param {*} value
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.setValue = function(thisObject, valueName, value) {
  var /** @type {number} */ c = valueName.indexOf("-");
  while (c != -1) {
    valueName = valueName.substr(0, c) + valueName.charAt(c + 1).toUpperCase() + valueName.substr(c + 2);
    c = valueName.indexOf("-");
 ...
 * @return {*}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.newInstance = function(thisObject, valueName, state, attrs) {
  state = typeof state !== 'undefined' ? state : null;
  attrs = typeof attrs !== 'undefined' ? attrs : null;
 ...
 * @return {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.getInstance = function(valueName) {
 ...
 * @return {number}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.convertColor = function(value) {
 ...
 * @return {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.parseStyles = function(styles) {
  var /** @type {Object} */ obj = {};
 ...
 * @param {Object} values
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.addRule = function(ruleName, values) {
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.inheritingStyles = {"color":1, "fontFamily":1, "fontSize":1, "fontStyle":1, "textAlign":1};
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.perInstanceStyles = {'backgroundColor':1, 'backgroundImage':1, 'color':1, 'fontFamily':1, 'fontWeight':1, 'fontSize':1, 'fontStyle':1};
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.colorStyles = {'backgroundColor':1, 'borderColor':1, 'color':1};
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.numericStyles = {'fontWeight':1};
 ...
 * @type {Object}
 */
org.apache.flex.core.AllCSSValuesImpl.skipStyles = {'constructor':1};
 ...
 * @param {Object} styles
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.applyStyles = function(thisObject, styles) {
  var /** @type {Object} */ styleList = org.apache.flex.core.AllCSSValuesImpl.perInstanceStyles;
  var /** @type {Object} */ colorStyles = org.apache.flex.core.AllCSSValuesImpl.colorStyles;
  var /** @type {Object} */ skipStyles = org.apache.flex.core.AllCSSValuesImpl.skipStyles;
  var /** @type {Object} */ numericStyles = org.apache.flex.core.AllCSSValuesImpl.numericStyles;
 ...
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.FLEXJS_CLASS_INFO = { names: [{ name: 'AllCSSValuesImpl', qName: 'org.apache.flex.core.AllCSSValuesImpl', kind: 'class' }], interfaces: [org.apache.flex.core.IValuesImpl, org.apache.flex.core.ICSSImpl] };


/**
 * Prevent renaming of class. Needed for reflection.
 */
goog.exportSymbol('org.apache.flex.core.AllCSSValuesImpl', org.apache.flex.core.AllCSSValuesImpl);
 ...
 */
org.apache.flex.core.AllCSSValuesImpl.prototype.FLEXJS_REFLECTION_INFO = function () {
  return {
    variables: function () {
      return {
        'values': { type: 'Object'},
    ...
    methods: function () {
      return {
        'AllCSSValuesImpl': { type: '', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl'},
        'init': { type: 'void', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'Object', optional: false } ]; }},
        'getValue': { type: '*', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'String', optional: false },{ index: 3, type: 'String', optional: true },{ index: 4, type: 'Object', optional: true } ]; }},
        'setValue': { type: 'void', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'String', optional: false },{ index: 3, type: '*', optional: false } ]; }},
        'newInstance': { type: '*', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'Object', optional: false },{ index: 2, type: 'String', optional: false },{ index: 3, type: 'String', optional: true },{ index: 4, type: 'Object', optional: true } ]; }},
        'getInstance': { type: 'Object', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'String', optional: false } ]; }},
        'convertColor': { type: 'uint', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'Object', optional: false } ]; }},
        'parseStyles': { type: 'Object', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'String', optional: false } ]; }},
        'addRule': { type: 'void', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'String', optional: false },{ index: 2, type: 'Object', optional: false } ]; }},
        'applyStyles': { type: 'void', declaredBy: 'org.apache.flex.core.AllCSSValuesImpl', parameters: function () { return [  { index: 1, type: 'org.apache.flex.core.IUIBase', optional: false },{ index: 2, type: 'Object', optional: false } ]; }}
      };
    }
  };
};