 ...
 * @type {boolean}
 */
org.apache.flex.core.LayoutBase.prototype.sawInitComplete;
...
org.apache.flex.core.LayoutBase.prototype.childResizeHandler = function(event) {
  var /** @type {org.apache.flex.core.ILayoutHost} */ viewBead;
  if (event.type == "widthChanged" && !(this.host.isWidthSizedToContent() || !isNaN(this.host.explicitWidth))) {
    viewBead = org.apache.flex.utils.Language.as(this.host, org.apache.flex.core.ILayoutParent).getLayoutHost();
...
org.apache.flex.core.LayoutBase.prototype.performLayout = function() {
  ...
  if (this.host.width != oldWidth || this.host.height != oldHeight) {
    this.isLayoutRunning = true;
    this.host.dispatchEvent(new org.apache.flex.events.Event("sizeChanged"));
    this.isLayoutRunning = false;
  }
};
