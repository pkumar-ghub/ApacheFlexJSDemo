...
org.apache.flex.html.beads.DateChooserView.prototype.createChildren = function() {
  ...
  this.monthButtonsContainer.className = "opt_org-apache-flex-html-DateChooser_MonthButtons";
  this.monthButtonsContainer.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
  ...
  if (this._prevMonthButton.style == null) {
    this._prevMonthButton.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
  }
  ...
  if (this.monthLabel.style == null) {
    this.monthLabel.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
  }
  ...
  if (this._nextMonthButton.style == null) {
    this._nextMonthButton.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
  }
  ...
  this.dayNamesContainer.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
  ...
  this.daysContainer.style = new org.apache.flex.core.SimpleCSSStylesWithFlex();
