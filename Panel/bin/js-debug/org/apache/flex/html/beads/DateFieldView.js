 ...
 */
org.apache.flex.html.beads.DateFieldView.prototype.handleInitComplete = function(event) {
  ...
  this._textInput.height = this._button.height;
};
...
org.apache.flex.html.beads.DateFieldView.prototype.set__strand = function(value) {
  ...
  org.apache.flex.utils.Language.as(this._strand, org.apache.flex.events.IEventDispatcher, true).addEventListener("initComplete", org.apache.flex.utils.Language.closure(this.handleInitComplete, this, 'handleInitComplete'));
};
